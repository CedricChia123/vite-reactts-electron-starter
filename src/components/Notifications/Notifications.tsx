...
export const Notifications: React.FC<{isPushEnabled: boolean; onPushChange: (isEnabled: boolean) => void; }> = ({ isPushEnabled, onPushChange }) => {
  ...
  return (
    <Card className="w-full md:w-[390px] h-full flex flex-col">
      <CardHeader>
        ...
        <CardDescription>You have {Array.isArray(notifications) ? notifications.length - readNotifications.size : '0'} unread messages.</CardDescription>
      </CardHeader>
      <CardContent className="flex-1 overflow-auto">
        ...
        {Array.isArray(notifications) && [...notifications].reverse().map((notification, index) => (
          <div
            key={index}
